...
public class BinaryTree extends BinaryTreeBasis
{
  ...
  /*public HTreeNode addRecursive(HTreeNode curr, Object item) 
  {
	  if(curr == null) 
	  {
  ...
  public void setRootItem(Object newItem)
  {
    ...
    {
      root = new HTreeNode(newItem, null, null);
    }  // end if
  }  // end setRootItem
  ...
  public void attachLeft(Object newItem)
  {
    if (!isEmpty() && root.getLeft() == null)
    {
      ...
      root.setLeft(new HTreeNode(newItem, null, null));
    }  // end if
  }  // end attachLeft
  ...
  public void attachRight(Object newItem)
  {
    if (!isEmpty() && root.getRight() == null)
    {
      ...
      root.setRight(new HTreeNode(newItem, null, null));
    }  // end if
  }  // end attachRight
  ...
  protected BinaryTree(HTreeNode rootNode)
  {
    root = rootNode;
